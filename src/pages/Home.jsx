...
import Gridania from '../assets/BlackShroud/Gridania/Gridania.jpg'
import Limsa from '../assets/LaNoscea/Limsa/Limsa.jpg'
import Uldah from '../assets/Thanalan/Uldah/Uldah.jpeg'
import Ishgard from '../assets/Coerthas/Ishgard/Ishgard.jpg'
  ...
  return (
    <div className='w-full h-[200vh] mt-[5%]' id='home'>
      ...
      <div className={`max-w-7xl mx-auto flex-col justify-center items-center px-7 bg-gray-100 rounded-md pb-12 shadow-lg`}>
        ...
        <div>
          <FiChevronsDown className='mx-auto animate-bounce'/>
        </div>
      </div>
